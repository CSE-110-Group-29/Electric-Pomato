...
4. Funcitonality.
    ...
    - __Prompt the user to input more tasks if they completed all their tasks for the day__: ~~perhaps the user may want to do more tasks in a single day, and this doesn't add much complexity.~~
